        ...
        <div class="col md-3">
          <div class="card" style="width: 18rem; display:flex; py-3; margin-bottom: 20px;">
            ...
            <div class="card-body d-flex justify-content-between" style="height:50%;">
              <button type="button" class="btn btn-primary" onclick="window.open('${film.officialSite}')">Go to Website</button>
              <button type="button" class="btn btn-success" onclick="window.open('./Details.html?id=${film.id}')">Go to detail</button>
            </div>
          </div>
        </div>
      `;
